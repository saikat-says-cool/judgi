...
- [x] **3.1.9 User Font Family Selection:** Removed font family selection from the `RichTextEditor`.
- [x] **3.1.10 AI Output Font Control:** Removed AI output font control from the `CanvasAIAssistant`.
