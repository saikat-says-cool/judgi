...
const ChatModes: React.FC = () => {
  ...
  // Custom classes for the 'on' state to make them more visible
  const activeToggleClasses = "data-[state=on]:bg-primary data-[state=on]:text-primary-foreground";

  return (
    <div className="flex flex-col gap-2 p-2 border-t border-b border-border bg-card">
      {/* Research Modes Section */}
      <div className="flex flex-wrap items-center gap-2">
        <span className="text-sm font-medium text-muted-foreground">Research Modes:</span>
        ...
        >
          <Tooltip>
            <TooltipTrigger asChild>
              <ToggleGroupItem value="none" aria-label="No Legal Research" className={activeToggleClasses}>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <ToggleGroupItem value="medium" aria-label="Medium Legal Research" className={activeToggleClasses}>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <ToggleGroupItem value="max" aria-label="Max Legal Research" className={activeToggleClasses}>
      ...
      {/* Deepthink Section - right-aligned */}
