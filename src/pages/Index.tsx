...
import InstructionsPage from './InstructionsPage'; // Import the new protected instructions page
    ...
    <div className="flex h-screen">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <Routes>
          ...
          <Route path="instructions" element={<InstructionsPage />} /> {/* Protected instructions route */}
